...
-- Listage des données de la table siteblacklions.doctrine_migration_versions : ~1 rows (environ)
...
-- Listage des données de la table siteblacklions.user : ~1 rows (environ)
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `nickname`, `date_create`, `discord_nickname`, `is_verified`) VALUES
	(2, 'admin@admin.fr', '[]', '$2y$13$qbq1eUwI0xacOVsZrNY5COVuUOtFlYdK.G/VvQOoQ12oJnRWbu6vu', 'Admin', '2023-05-26', NULL, 1);
